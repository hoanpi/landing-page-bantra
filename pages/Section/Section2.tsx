...
export default function Selection2() {
  return (
    <section id='pricing' className='align--center gray-bg pt2 pb3'>
      <div className='container'>
        <div className='row justify-content-center'>
          <div className='col-lg-8'>
            <div className='section-title align--center pb1'>
              <h2 className='title'>Bảng giá từng loại</h2>
              <p>
                <strong>Đặc sản chè Thái Nguyên</strong> từ lâu đã trở thành thương hiệu ăn sâu vào trong máu của những
                người yêu trà. Nhắc đến chè Thái Nguyên là nhắc đến cái hương thơm cốm non ngào ngạt, vị chát nơi đầu
                lưỡi, bùi bùi, hậu ngọt sâu lắng làm say mê biết bao người mê trà.
              </p>
            </div>
          </div>
        </div>
